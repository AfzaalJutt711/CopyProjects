...
function ShoppingListing() {
  ...
  useEffect(() => {
    if (filters !== null && sort !== null)
      dispatch(fetchAllFilteredProducts({ filterParams: filters, sortParmas: sort }))
              ...
              <DropdownMenuRadioGroup value={sort} onValueChange={handleSort}>
                {
                  sortOptions.map(sortItems => (
                    <DropdownMenuRadioItem value={sortItems.id} key={sortItems.id}>{sortItems.label}</DropdownMenuRadioItem>
                  ))
                }
